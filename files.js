        ...
        function t(t) {
            ...
            k(_tag("time"), (function(t) {
                if (t.dataset.time) {
                    ...
                    t.dataset.titleFormat && (t.title = i.format(t.dataset.titleFormat) + " 鈥� " + i.fromNow())
                }
            }
            )),
    ...
    _c.allow_upload && P.load_plugin("uppy", (function() {
        ...
        var e = q.uppy = new Uppy.Core({
            ...
            e.getPlugin("Dashboard").setOptions({
                note: _c.upload_note ? _c.upload_note.replace("%upload_max_filesize%", i).replace("%path%", a) : a + (i ? " 鈮� " + i : "")
            })
        }
...
/**        _c.check_updates && (E.get("files:updated") ? (E.remove("files:updated"),
        t("鉁� Successfully updated to Files app version " + _c.version),
                                ...
                                I({
                                    ...
                                    complete: function(i, a, n) {
                                        ...
                                        i && a && n && i.hasOwnProperty("success") && i.success) {
                                            ...
                                            try {
                                                e.dataset.updated = "鉁� Success! Reloading ...",
                                                location.reload(!0)
                                            } catch (t) {
                                                e.dataset.updated = "鉁� Success! Please refresh ..."
                                            }
                                        } else
                                            t("鉁� Failed to load update :(")
                                    }
                                }))
                            }
                            ))
